...
cd /home/justin/servername || exit 1
screen -DmS servername java -Xmx2G -Xms512M -jar paper.jar nogui" > start.sh
...
echo "Server Starting ... (DISABLED FOR WATERFALL PURPOSE, PLEASE ADJUST THE SETTINGS!!!)"
#bash start.sh
